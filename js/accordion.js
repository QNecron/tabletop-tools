; (function (w, doc, undefined) {
  ...
  var widgetClass = 'accordion-container';
  var widgetTriggerClass = 'nav-secondary-title';
  var widgetHeadingClass = 'accordion-title';
  var widgetPanelClass = 'accordion-content';
  ...
  ARIAaccordion.setupHeadingButton = function (headings, constantPanel) {
    ...
    for (i = 0; i < headings.length; i++) {
      ...
      // setup material icon
      newButtonIcon = doc.createElement('i');
      newButtonIcon.innerHTML = 'keyboard_arrow_down';
      newButtonIcon.setAttribute('aria-hidden', 'true');
      newButtonIcon.classList.add('material-icons');
